  ...
  <div style="min-height: 100vh;background-color: #fff">
    ...
    <van-cell-group style="margin-top: 50px;" v-if="active == 0">
      <van-field
        ...
        style="width: 96%"
      >
        <img class="iconImg" slot="left-icon" src="../../assets/img/phone.png" alt="">
      </van-field>
      <van-field
        type="tel"
        clearable
      ...
      >
        ...
        <img class="iconImg" slot="left-icon" src="../../assets/img/password.png" alt="">
      </van-field>
    </van-cell-group>
    ...
    <div class="login">
      <van-button v-waves round type="danger" class="login" @click="submit">下一步</van-button>
    </div>
