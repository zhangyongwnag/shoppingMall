...
function jsCallbackFunc(callbackId, resultData) {
...
export function date(result) {
  return new Date(result).format("yyyy-MM-dd")
}

export function dateTime(result) {
  return new Date(result).format("yyyy-MM-dd hh:mm")
}

export function dateFromat(result) {
  return new Date(result).format("yyyy年MM月dd日 上午hh:mm")
}

export function dateCoutince(result) {
  return new Date(result).format("yyyyMMdd")
}
